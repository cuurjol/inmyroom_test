    ...
    def call
      ...
      if old_product.warehouse == new_warehouse
        ...
        ActiveRecord::Base.transaction do
          ...
          # new_product = Product.create_with(quantity: quantity).find_or_create_by(new_product_params)
      ...
      { params: @params, old_product: old_product, new_product: new_product, success: false, error: e.message }
    end
  end
end
